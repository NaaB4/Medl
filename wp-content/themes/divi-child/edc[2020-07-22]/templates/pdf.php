<html style="font-family: Arial,sans-serif;">
	...
	<style>
		...
		*{ font-family: 'IBMPlexSerif-Regular', Helvetica, Arial, Lucida, sans-serif; box-sizing: border-box; }
		...
		.checkbox{ border: 1px solid #<?=$color?>; margin-right: 4px; vertical-align: middle; display: inline-block; width: 12px; height: 12px; margin-top: 2px; text-align: center; font-size: 10px; line-height: 8px; }
	</style>
	<body style="margin: auto">
		<div>
			...
			<table>
				<tr class="bbottom bgray row small">
					<td class="row_cell cell_half"><span class="cgreen"><div class="checkbox"><?=($data['options']['cancel_old']==0 ? '&#10003;' : '')?></div> Ich habe bereits bei meinem aktuellen Lieferanten zu folgendem Datum gekündigt:</span></td>
					<td class="row_cell cell_half"><span class="cgreen"><div class="checkbox"><?=($data['options']['cancel_old']==1 ? '&#10003;' : '')?></div> Ich habe noch nicht bei meinem aktuellen Lieferanten gekündigt und möchte zum schnellstmöglichen Termin zur medl GmbH wechseln.</span></td>
				</tr>
			</table>
			<div style="color:#fff;padding: 3px 8px;font-weight:bold;font-size:12px;" class="bgreen bbottom">
			...
			<table>
				...
				<tr class="bbottom bgray row smaller">
					...
					<td class="row_cell cell_1_5"><span><?=$data['options']['edc_previous']?></span></td>
					<td class="row_cell cell_1_5"><span><?=$data['options']['edc_contract']?></span></td>
			...
			<div style="margin-top: 15px;">
				...
				<div class="checkbox"><?=(EDCH::is($data['options']['edc_mobile_checkbox']) ? '&#10003;' : '')?></div> Ja, ich willige ein, telefonisch über meine genannte Telefon- oder Mobilrufnummer zu den vorstehend genannten Zwecken der
				Produktwerbung und Marktforschung von medl kontaktiert zu werden.<br>
				<div class="checkbox"><?=(EDCH::is($data['options']['edc_email_checkbox']) ? '&#10003;' : '')?></div> Ja, ich willige ein, per E-Mail über meine genannte E-Mail-Adresse zu den vorstehend genannten Zwecken der
				Produktwerbung und Marktforschung von medl kontaktiert zu werden.<br>
