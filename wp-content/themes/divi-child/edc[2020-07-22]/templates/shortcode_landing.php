	...
	<div class="edc_tabs <?=isset($data['dop_class']) ? $data['dop_class'] : ''?>" id="edc_<?=$edc_counter?>" data-tab="<?=isset($data['active']) ? $data['active'] : ''?>">
		...
		<div class="items">
			<form class="edc_tab" action="<?=EDCH::getTariffsPageURL()?>" method="POST" onsubmit="return false;">
				...
				<?php if(EDCH::is($data['discount'])) : ?>
					<div class="edc_form_row location">
						<div class="edc_radio">
							<input type="radio" name="discount" id="edc_e_discount_1_<?=$edc_counter?>" style="display:none;" value="1">
							<label for="edc_e_discount_1_<?=$edc_counter?>">heimkehrer-Wechselbonus 120 Euro Reduzierung des Abschlages</label>
						</div>
					</div>		
					<div class="edc_form_row location">
						<div class="edc_radio">
							<input type="radio" name="discount" id="edc_e_discount_2_<?=$edc_counter?>" style="display:none;" value="0">
							<label for="edc_e_discount_2_<?=$edc_counter?>">heimkehrer-Wechselbonus 120 Euro Auszahlung</label>
						</div>
					</div>					
				<?php endif; ?>
				<div class="submit_group">
					...
					<?php if(isset($data['lp'])) : ?>
						<input type="hidden" name="lp" value="<?=$data['lp']?>">
					<?php endif; ?>
				</div>
			...
			<form class="edc_tab" action="<?=EDCH::getTariffsPageURL()?>" method="POST" onsubmit="return false;">
				...
				<?php if(EDCH::is($data['discount'])) : ?>
					<div class="edc_form_row location">
						<div class="edc_radio">
							<input type="radio" name="discount" id="edc_g_discount_1_<?=$edc_counter?>" style="display:none;" value="1">
							<label for="edc_g_discount_1_<?=$edc_counter?>">heimkehrer-Wechselbonus 120 Euro Reduzierung des Abschlages</label>
						</div>
					</div>		
					<div class="edc_form_row location">
						<div class="edc_radio">
							<input type="radio" name="discount" id="edc_g_discount_2_<?=$edc_counter?>" style="display:none;" value="0">
							<label for="edc_g_discount_2_<?=$edc_counter?>">heimkehrer-Wechselbonus 120 Euro Auszahlung</label>
						</div>
					</div>					
				<?php endif; ?>
				<div class="submit_group">
			...
			<form class="edc_tab" action="<?=EDCH::getTariffsPageURL()?>" method="POST" onsubmit="return false;">
				...
				<?php if(EDCH::is($data['discount'])) : ?>
					<div class="edc_form_row location">
						<div class="edc_radio">
							<input type="radio" name="discount" id="edc_c_discount_1_<?=$edc_counter?>" style="display:none;" value="1">
							<label for="edc_c_discount_1_<?=$edc_counter?>">heimkehrer-Wechselbonus 120 Euro Reduzierung des Abschlages</label>
						</div>
					</div>		
					<div class="edc_form_row location">
						<div class="edc_radio">
							<input type="radio" name="discount" id="edc_c_discount_2_<?=$edc_counter?>" style="display:none;" value="0">
							<label for="edc_c_discount_2_<?=$edc_counter?>">heimkehrer-Wechselbonus 120 Euro Auszahlung</label>
						</div>
					</div>					
				<?php endif; ?>
				<div class="submit_group">
