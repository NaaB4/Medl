			...
			<form class="order_form" name="edc_order_form" action="<?=EDCH::getResultPageURL($data['tariff']->id)?>" method="POST" onsubmit="return false;">
				<div class="form_wrapper">
					...
					<div class="fieldset">
						...
						<div class="col_1_4">
							<div class="name"><?=__('Hausnummrenzusatz','medl')?>:</div>
							<div class="field">
								<input type="text" name="edc_house_zuratc" value="">
							</div>
						</div>
					</div>
					<div class="fieldset">
					...
					<div class="fieldset">
						<?php if(EDCH::proceedType($data['tariff']->type,true)!='combi') : ?>
							<div>
								<div class="name"><?=__('Vorjahresverbrauch','edc')?> <span class="red">*</span>:</div>
								<div class="field">
						...
						<?php else : ?>
							<div class="col_1_2">
								<div class="name"><?=__('Vorjahresverbrauch (Erdgas)','edc')?> <span class="red">*</span>:</div>
								<div class="field">
									<input type="text" name="annual_gas" value="<?=$data["annual_consumption_gas"]?>" <?=($data['skiped_first'] ? '' : 'disabled')?>>
								</div>
							</div>
							<div class="col_1_2">
								<div class="name"><?=__('Vorjahresverbrauch (Strom)','edc')?> <span class="red">*</span>:</div>
								<div class="field">
