	...
	public function extendOrderOptions($options=[]){
		$options['change']=[
			...
			'items'=>array(
				...
				'zu_wann_hast'=>array(
					'name'=>__('Zu wann hast du gekündigt','medl'),
					'field'=>'option',
				),
				'self_mail_sent'=>array(
					'name'=>__('Mail to administrator was sent','medl'),
					'field'=>'option',
				),
				'customer_mail_sent'=>array(
					'name'=>__('Mail to customer was sent','medl'),
					'field'=>'option',
				),
			),
		];
