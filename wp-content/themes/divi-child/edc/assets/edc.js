(function(w,edc,edcp){
	...
	edcp.displayChangeFields=function(el){
		...
		if(el.value=='new'){
			...
			if(document.body.querySelector('#counter_fields_holder > div:nth-child(3)')){
				document.body.querySelector('#counter_fields_holder > div:nth-child(1)').className='col_1_2';
				document.body.querySelector('#counter_fields_holder > div:nth-child(2)').className='col_1_2';
				document.body.querySelector('#counter_fields_holder > div:nth-child(3)').style.display='block';
				document.body.querySelector('#counter_fields_holder > div:nth-child(4)').style.display='block';				
			}else{
				document.body.querySelector('#counter_fields_holder > div:nth-child(1)').className='col_1_2';
			...
			if(document.body.querySelector('#counter_fields_holder > div:nth-child(3)')){
				...
				document.body.querySelector('#counter_fields_holder > div:nth-child(2)').className='';
				document.body.querySelector('#counter_fields_holder > div:nth-child(3)').style.display='none';
				document.body.querySelector('#counter_fields_holder > div:nth-child(4)').style.display='none';
	...
	edcp.displayCancelFields=function(el){
		...
		let cont4=f.querySelectorAll('.change_fields');
		if(this.is(el.value)){
			cont.style.display='block';
			...
			for(let i=0;i<cont4.length;++i) cont4[i].style.display='none';
