<html style="font-family: Arial,sans-serif;">
	...
	<body style="margin: auto">
		<div>
			...
			<table>
				<tr class="bbottom bgray row small">
					<td class="row_cell left_cell2"><span><?=$data['options']['edc_street'].' '.$data['options']['edc_house'].' '.$data['options']['edc_house_zuratc']?></span></td>
			...
			<table>
				<tr class="bbottom bgray row small">
					<td class="row_cell cell_half"><span class="cgreen"><div class="checkbox"><?=($data['options']['cancel_old']==0 ? '&times;' : '')?></div> Ich habe bereits bei meinem aktuellen Lieferanten zu folgendem Datum gekündigt:</span> <?=$data['options']['zu_wann_hast']?></td>
					<td class="row_cell cell_half"><span class="cgreen"><div class="checkbox"><?=($data['options']['cancel_old']==1 ? '&times;' : '')?></div> Ich habe noch nicht bei meinem aktuellen Lieferanten gekündigt und möchte zum schnellstmöglichen Termin zur medl GmbH wechseln.</span></td>
				</tr>
			</table>
			<div style="color:#fff;padding: 3px 8px;font-weight:bold;font-size:12px;" class="bgreen bbottom">
