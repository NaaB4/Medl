	...
	<div class="tarifbox strompur">
		<div class="tarifbox-body">
			<div class="col-1 col">
				...
				<div class="et_pb_button_wrapper tarifbox-button"><a class="et_pb_button et_pb_pricing_table_button" href="javascript:void(0);" onclick="edc.showTariffsPopup(<?=$data['example_annual_consumption']?>,'<?=$data['type']?>','<?=$data['tariff_ids']?>',<?=$data['young']?>);">Her damit!</a></div>
			</div>
		</div>
