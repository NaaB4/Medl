...
<head>
	...
	<link rel="preload" href="https://medl.de/wp-content/uploads/et-fonts/IBMPlexSerif-Bold.ttf" as="font" crossorigin="anonymous" />
	<link rel="preload" href="https://medl.de/wp-content/uploads/et-fonts/IBMPlexSerif-Regular.ttf" as="font" crossorigin="anonymous" />
	<link rel="preload" href="https://medl.de/wp-content/uploads/et-fonts/Anton-Regular.ttf" as="font" crossorigin="anonymous" />
	<link rel="preload" href="https://medl.de/wp-content/uploads/et-fonts/IBMPlexSerif-SemiBold.ttf" as="font" crossorigin="anonymous" />
	<link rel="preload" href="https://medl.de/wp-content/uploads/et-fonts/IBMPlexSerif-Medium.ttf" as="font" crossorigin="anonymous" />
	<link rel="preload" href="https://medl.de/wp-content/themes/Divi/core/admin/fonts/modules.ttf" as="font" crossorigin="anonymous" />
...
?>
		...
		<div id="top-header"<?php echo $et_top_info_defined ? '' : 'style="display: none;"'; ?>>
			...
			<?php endif; // true === $et_contact_info_defined ?>
				...
				<div id="et-secondary-menu">
					...
					<div id="ieBar" class="ieBar">
						<div class="ieBarWrapper">
							<img src="/wp-content/uploads/warn.png"/>
							<div>
								<h3>Eingeschränkte Funktionalität</h3>
								<p>Bitte beachte, dass unsere Internetseite nicht für diesen Browser optimiert ist. <br />
								Um alle Funktionalitäten nutzen zu können, öffne unsere Seite (<a href="www.medl.de">www.medl.de</a>) in Firefox, Chrome oder Safari.<a id="ieBarConfirm" class="ieBarClose">&#10060;</a></p>
							</div>
						</div>
					</div>
	...
	<?php ob_start(); ?>
		<header id="main-header" data-height-onload="<?php echo esc_attr( et_get_option( 'menu_height', '66' ) ); ?>">
			...
			?>
				<div style="padding-left: 500px;" id="et-top-navigation" data-height="<?php echo esc_attr( et_get_option( 'menu_height', '66' ) ); ?>" data-fixed-height="<?php echo esc_attr( et_get_option( 'minimized_menu_height', '40' ) ); ?>">
					<?php if ( ! $et_slide_header || is_customize_preview() ) : ?>
						<nav id="top-menu-nav">
						<?php
							$menuClass = 'nav';
