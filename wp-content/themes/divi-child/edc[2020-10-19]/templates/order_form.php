		...
		<div class="container">
			<form class="order_form" name="edc_order_form" action="<?=EDCH::getResultPageURL($data['tariff']->id)?>" method="POST" onsubmit="return false;">
				<div class="form_wrapper">
						...
						<div class="col_1_2">
							...
							<div class="field">
								<select name="edc_anrede"><?=EDCH::simpleOptions(array(
									array('name'=>__('Bitte auswählen','medl'),'value'=>''),
					...
					<fieldset id="etc_fields">			
						...
						<div class="fieldset">
							...
							<div class="col_1_4">
								<div class="name"><?=__('Hausnummerzusatz','medl')?>:</div>
								<div class="field">
									<input type="text" name="edc_etc_house_zuratc" value="" maxlength="3">
								</div>
							</div>
						</div>
						<div class="fieldset">
					...
					<div id="art_des_fields" style="display:none;">
						<fieldset id="change_fields" style="display:none;">
							...
							<div class="fieldset">
								...
								<div class="col_1_4">
									<div class="name"><?=__('Hausnummerzusatz','medl')?>:</div>
									<div class="field">
										<input type="text" name="change_house" value="" maxlength="3">
									</div>
								</div>
							</div>
							<div class="fieldset">
						...
						<div class="change_fields">
							...
							<div id="cancel_old" style="display:none;">
								<div class="fieldset">
									<div class="field type2 to_top">
										<?php if($data['tariff']->options['edc_sollen_text']!=''){
											$sollen_text=$data['tariff']->options['edc_sollen_text'];
										}else{
											$sollen_text='Der Kunde beauftragt die medl GmbH mit der Belieferung von Strom. Der Kunde bevollmächtigt die medl GmbH, für die genannte Lieferstelle den bestehenden Stromliefervertrag zu kündigen und den für die Lieferung erforderlichen Vertrag mit dem örtlichen Netzbetreiber abzuschließen. Der Vertrag kommt mit der Vertragsbestätigung der medl GmbH in Textform zustande.';
										}?>
										
										<input type="checkbox" name="cancel_old_check" id="cancel_old_check" style="display:none;" value="1">
										<label class="edc_checkbox" for="cancel_old_check"><?=$sollen_text?> <span class="red">*</span></label>
										<div class="required_text"><?=__('This field required','edc')?></div>
									</div>
								</div>
								<!--<div class="fieldset">
									<div>
										<div class="name"><?=__('Zu wann hast du gekündigt?','medl')?></div>
										<div class="fieldset tleft inline near">					
											<div>
												<div class="field type2 edc_radio">
													<input type="radio" name="zu_wann_hast" id="zu_wann_hast_1" style="display:none;" value="1" onchange="edc.displaySollen(this);">
													<label for="zu_wann_hast_1">Ja</label>
												</div>
											</div>
											<div>
												<div class="field type2 edc_radio">
													<input type="radio" name="zu_wann_hast" id="zu_wann_hast_2" style="display:none;" value="0" onchange="edc.displaySollen(this);">
													<label for="zu_wann_hast_2">Nein</label>
												</div>
											</div>
										</div>
									</div>
							...
							<div class="cancel_old" style="display:none;">								
								<div class="fieldset">
									<div>
										<div class="name"><?=__('Zu wann hast du gekündigt?','medl')?></div>
										<div class="field">
											<input type="text" name="zu_wann_hast" value="" class="datepicker_no_past">
										</div>
									</div>
								</div>
							</div>
						</div>
						<div class="change_fields" id="sollen_fields">
							<div class="form_title"><?=__('Ab wann sollen wir dich beliefern?','medl')?> <span class="red">*</span>:</div>
							<div class="fieldset tleft inline near">					
								<div>
									<div class="field type2 edc_radio">
						...
						?>
						<div class="form_title change_fields2" style="display:none;"><?=__('Neue Adresse','medl')?></div>
						<div class="change_fields2">
							<div class="fieldset">
								<div>
									<div class="name"><?=__('Datum der Wohnungsübergabe','medl')?> <span class="red">*</span></div>
									<div class="field">
										<input type="text" name="edc_read_date" value="" class="datepicker2" data-required="1">
										<div class="required_text"><?=__('This field required','edc')?></div>
									</div>
									<div class="description"><?=__('Rückwirkend bis maximal 6 Wochen möglich','medl')?></div>
								</div>
							</div>
						</div>
						<div class="fieldset" id="counter_fields_holder">
							...
							<?php else : ?>
								<div class="col_1_2">
									...
									<div class="field">
										<input type="text" name="edc_electriс" value=""  class="only_numeric">
										<div class="required_text"><?=__('Enter counter number','edc')?></div>
									</div>
								</div>
								<div class="col_1_2">
									...
									<div class="field">
										<input type="text" name="edc_electriс_value" value="" data-required="1">
										<div class="required_text"><?=__('Enter counter number','edc')?></div>
									</div>
								</div>
								<div class="col_1_2">
									...
									<div class="field">
										<input type="text" name="edc_electriс2" value=""  class="only_numeric">
										<div class="required_text"><?=__('Enter counter number','edc')?></div>
									</div>
								</div>	
								<div class="col_1_2">
									...
									<div class="field">
										<input type="text" name="edc_electriс_value2" value="" data-required="1">
										<div class="required_text"><?=__('Enter counter number','edc')?></div>
									</div>
								</div>					
							<?php endif; ?>
						...
						<div class="fieldset">
							<?php if(EDCH::proceedType($data['tariff']->type,true)!='combi') : ?>
								<div>
									<div class="name"><?=__('Dein (geschätzter) Jahresverbrauch','edc')?> <span class="red">*</span>:</div>
									<div class="field">
										<input type="text" name="edc_consumption" value="<?=$data["annual_consumption"]?>" <?=($data['skiped_first'] ? '' : 'disabled')?>>
									</div>
								</div>						
							<?php else : ?>
								<div class="col_1_2">
									<div class="name"><?=__('Dein (geschätzter) Jahresverbrauch (Erdgas)','edc')?> <span class="red">*</span>:</div>
									<div class="field">
										<input type="text" name="annual_gas" value="<?=$data["annual_consumption_gas"]?>" <?=($data['skiped_first'] ? '' : 'disabled')?>>
									</div>
								</div>
								<div class="col_1_2">
									<div class="name"><?=__('Dein (geschätzter) Jahresverbrauch (Strom)','edc')?> <span class="red">*</span>:</div>
									<div class="field">
										<input type="text" name="annual_el" value="<?=$data["annual_consumption_el"]?>" <?=($data['skiped_first'] ? '' : 'disabled')?>>
									</div>
								</div>
							<?php endif; ?>
						</div>
					...
					<div>		
						<?php if($data['tariff']->options['edc_first_legal_cbx']!=''){
							$first_legal=$data['tariff']->options['edc_first_legal_cbx'];
						}else{
							$first_legal=EDCH::opts('get','edc_first_legal_text','settings');
						}?>
						<?php if($first_legal!='') : ?>
							<div class="fieldset">
								<div class="field type2 to_top">
									<input type="checkbox" name="legal1" id="legal1" style="display:none;" value="1" data-required="1">
									<label class="edc_checkbox" for="legal1"><?=$first_legal?></label>
									<div class="required_text"><?=__('This field required','edc')?></div>
								</div>
							</div>
						<?php endif; ?>
						...
						<?php if(EDCH::opts('get','edc_fourth_checkbox','settings')!='') : ?>
							<div class="fieldset">
								<div class="field type2 to_top">
									<input type="checkbox" name="legal4" id="legal4" style="display:none;" value="1" data-required="1">
									<label class="edc_checkbox" for="legal4"><?=EDCH::opts('get','edc_fourth_checkbox','settings')?></label>
									<div class="required_text"><?=__('This field required','edc')?></div>
								</div>
							</div>
						<?php endif; ?>			
					...
					<div style="margin-top: 20px;">*Pflichtfeld</div>
