				...
				<div class="edc_tariff_group main_group" id="main">
					...
					<div class="fields_wrapper">
						...
						<div class="fields_block">
							...
							<div class="label">
								<div class="col_2">
									<div class="field"><div class="name"><?=__('Valid from','edc')?></div><input type="text" placeholder="<?=__('after','edc')?>" name="valid_from" class="with_calendar" value="<?=$data['valid_from']?>"></div>
									<div class="field"><div class="name"><?=__('Valid to','edc')?></div><input type="text" placeholder="<?=__('until','edc')?>" name="valid_to" class="with_calendar" value="<?=$data['valid_to']?>"></div>
								</div>
							</div>
						</div>
					</div>
