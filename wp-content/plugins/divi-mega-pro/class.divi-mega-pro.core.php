	...
	class DiviMegaPro {
		...
		protected static function init_hooks() {
			...
			if ( !is_admin() && !self::is_divi_builder_enabled() && $pos === false ) {
				...
				// Divi Mega Pro call
				add_action( 'wp_footer', array( 'DiviMegaPro_Controller', '_init' ), 1 );
		...
		public static function getAllDiviMegaPros() {
			...
			try {
				...
				$divimegapros['ids'] = $divimegapros_in_post + $divimegapros_in_menus + $divimegapros_with_css_trigger + $divimegapros_in_widgets + $divimegapros_in_layouts;
